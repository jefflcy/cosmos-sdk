...
func (suite *KeeperTestSuite) SetupTest() {
	...
	suite.msgServer = keeper.NewMsgServerImpl(&bankKeeper)
	suite.encCfg = encCfg
}
...
func (suite *KeeperTestSuite) TestSendCoinsNewAccount() {
	...
	bankKeeper := suite.bankKeeper
	require.NoError(banktestutil.FundAccount(&bankKeeper, ctx, accAddrs[0], balances))
...
func (suite *KeeperTestSuite) TestSendCoins() {
	...
	bankKeeper := suite.bankKeeper
	require.NoError(banktestutil.FundAccount(&bankKeeper, ctx, accAddrs[1], balances))
...
func (suite *KeeperTestSuite) TestSendCoins_Invalid_SendLockedCoins() {
	...
	suite.mockFundAccount(accAddrs[1])
	bankKeeper := suite.bankKeeper
	suite.Require().NoError(banktestutil.FundAccount(&bankKeeper, suite.ctx, accAddrs[1], balances))
...
func (suite *KeeperTestSuite) TestMsgSendEvents() {
	...
	suite.mockFundAccount(accAddrs[0])
	bankKeeper := suite.bankKeeper
	require.NoError(banktestutil.FundAccount(&bankKeeper, ctx, accAddrs[0], newCoins))
...
func (suite *KeeperTestSuite) TestMsgMultiSendEvents() {
	...
	suite.mockFundAccount(accAddrs[0])
	bankKeeper := suite.bankKeeper
	require.NoError(banktestutil.FundAccount(&bankKeeper, ctx, accAddrs[0], sdk.NewCoins(sdk.NewInt64Coin(fooDenom, 50), sdk.NewInt64Coin(barDenom, 100))))
	...
	suite.mockFundAccount(accAddrs[0])
	require.NoError(banktestutil.FundAccount(&bankKeeper, ctx, accAddrs[0], sdk.NewCoins(sdk.NewInt64Coin(fooDenom, 50))))
	newCoins = sdk.NewCoins(sdk.NewInt64Coin(fooDenom, 50))

	suite.mockFundAccount(accAddrs[0])
	require.NoError(banktestutil.FundAccount(&bankKeeper, ctx, accAddrs[0], sdk.NewCoins(sdk.NewInt64Coin(barDenom, 100))))
	newCoins2 = sdk.NewCoins(sdk.NewInt64Coin(barDenom, 100))
...
func (suite *KeeperTestSuite) TestSpendableCoins() {
	...
	suite.mockFundAccount(accAddrs[0])
	bankKeeper := suite.bankKeeper
	require.NoError(banktestutil.FundAccount(&bankKeeper, ctx, accAddrs[0], origCoins))

	suite.mockFundAccount(accAddrs[1])
	require.NoError(banktestutil.FundAccount(&bankKeeper, ctx, accAddrs[1], origCoins))
...
func (suite *KeeperTestSuite) TestVestingAccountSend() {
	...
	// receive some coins
	suite.mockFundAccount(accAddrs[0])
	require.NoError(banktestutil.FundAccount(&bankKeeper, ctx, accAddrs[0], sendCoins))
