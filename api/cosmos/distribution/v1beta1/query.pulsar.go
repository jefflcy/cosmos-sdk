...
var (
	md_QueryLiquidityProviderRewardsRequest protoreflect.MessageDescriptor
)

func init() {
	file_cosmos_distribution_v1beta1_query_proto_init()
	md_QueryLiquidityProviderRewardsRequest = File_cosmos_distribution_v1beta1_query_proto.Messages().ByName("QueryLiquidityProviderRewardsRequest")
}

var _ protoreflect.Message = (*fastReflection_QueryLiquidityProviderRewardsRequest)(nil)

type fastReflection_QueryLiquidityProviderRewardsRequest QueryLiquidityProviderRewardsRequest

func (x *QueryLiquidityProviderRewardsRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryLiquidityProviderRewardsRequest)(x)
}

func (x *QueryLiquidityProviderRewardsRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryLiquidityProviderRewardsRequest_messageType fastReflection_QueryLiquidityProviderRewardsRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryLiquidityProviderRewardsRequest_messageType{}

type fastReflection_QueryLiquidityProviderRewardsRequest_messageType struct{}

func (x fastReflection_QueryLiquidityProviderRewardsRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryLiquidityProviderRewardsRequest)(nil)
}
func (x fastReflection_QueryLiquidityProviderRewardsRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryLiquidityProviderRewardsRequest)
}
func (x fastReflection_QueryLiquidityProviderRewardsRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryLiquidityProviderRewardsRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryLiquidityProviderRewardsRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryLiquidityProviderRewardsRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) New() protoreflect.Message {
	return new(fastReflection_QueryLiquidityProviderRewardsRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryLiquidityProviderRewardsRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsRequest"))
		}
		panic(fmt.Errorf("message cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsRequest"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsRequest"))
		}
		panic(fmt.Errorf("message cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsRequest"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsRequest"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsRequest"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryLiquidityProviderRewardsRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryLiquidityProviderRewardsRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryLiquidityProviderRewardsRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryLiquidityProviderRewardsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
var _ protoreflect.List = (*_QueryLiquidityProviderRewardsResponse_1_list)(nil)

type _QueryLiquidityProviderRewardsResponse_1_list struct {
	list *[]*v1beta1.DecCoin
}

func (x *_QueryLiquidityProviderRewardsResponse_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryLiquidityProviderRewardsResponse_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryLiquidityProviderRewardsResponse_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.DecCoin)
	(*x.list)[i] = concreteValue
}

func (x *_QueryLiquidityProviderRewardsResponse_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.DecCoin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryLiquidityProviderRewardsResponse_1_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.DecCoin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryLiquidityProviderRewardsResponse_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QueryLiquidityProviderRewardsResponse_1_list) NewElement() protoreflect.Value {
	v := new(v1beta1.DecCoin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryLiquidityProviderRewardsResponse_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_QueryLiquidityProviderRewardsResponse      protoreflect.MessageDescriptor
	fd_QueryLiquidityProviderRewardsResponse_pool protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_distribution_v1beta1_query_proto_init()
	md_QueryLiquidityProviderRewardsResponse = File_cosmos_distribution_v1beta1_query_proto.Messages().ByName("QueryLiquidityProviderRewardsResponse")
	fd_QueryLiquidityProviderRewardsResponse_pool = md_QueryLiquidityProviderRewardsResponse.Fields().ByName("pool")
}

var _ protoreflect.Message = (*fastReflection_QueryLiquidityProviderRewardsResponse)(nil)

type fastReflection_QueryLiquidityProviderRewardsResponse QueryLiquidityProviderRewardsResponse

func (x *QueryLiquidityProviderRewardsResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryLiquidityProviderRewardsResponse)(x)
}

func (x *QueryLiquidityProviderRewardsResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryLiquidityProviderRewardsResponse_messageType fastReflection_QueryLiquidityProviderRewardsResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryLiquidityProviderRewardsResponse_messageType{}

type fastReflection_QueryLiquidityProviderRewardsResponse_messageType struct{}

func (x fastReflection_QueryLiquidityProviderRewardsResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryLiquidityProviderRewardsResponse)(nil)
}
func (x fastReflection_QueryLiquidityProviderRewardsResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryLiquidityProviderRewardsResponse)
}
func (x fastReflection_QueryLiquidityProviderRewardsResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryLiquidityProviderRewardsResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryLiquidityProviderRewardsResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryLiquidityProviderRewardsResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) New() protoreflect.Message {
	return new(fastReflection_QueryLiquidityProviderRewardsResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryLiquidityProviderRewardsResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Pool) != 0 {
		value := protoreflect.ValueOfList(&_QueryLiquidityProviderRewardsResponse_1_list{list: &x.Pool})
		if !f(fd_QueryLiquidityProviderRewardsResponse_pool, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse.pool":
		return len(x.Pool) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse"))
		}
		panic(fmt.Errorf("message cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse.pool":
		x.Pool = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse.pool":
		if len(x.Pool) == 0 {
			return protoreflect.ValueOfList(&_QueryLiquidityProviderRewardsResponse_1_list{})
		}
		listValue := &_QueryLiquidityProviderRewardsResponse_1_list{list: &x.Pool}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse"))
		}
		panic(fmt.Errorf("message cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse.pool":
		lv := value.List()
		clv := lv.(*_QueryLiquidityProviderRewardsResponse_1_list)
		x.Pool = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse.pool":
		if x.Pool == nil {
			x.Pool = []*v1beta1.DecCoin{}
		}
		value := &_QueryLiquidityProviderRewardsResponse_1_list{list: &x.Pool}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse.pool":
		list := []*v1beta1.DecCoin{}
		return protoreflect.ValueOfList(&_QueryLiquidityProviderRewardsResponse_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryLiquidityProviderRewardsResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryLiquidityProviderRewardsResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryLiquidityProviderRewardsResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryLiquidityProviderRewardsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *QueryLiquidityProviderRewardsRequest) Reset() {
	*x = QueryLiquidityProviderRewardsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_distribution_v1beta1_query_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryLiquidityProviderRewardsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryLiquidityProviderRewardsRequest) ProtoMessage() {}

// Deprecated: Use QueryLiquidityProviderRewardsRequest.ProtoReflect.Descriptor instead.
...
func (x *QueryLiquidityProviderRewardsResponse) Reset() {
	*x = QueryLiquidityProviderRewardsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_distribution_v1beta1_query_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryLiquidityProviderRewardsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryLiquidityProviderRewardsResponse) ProtoMessage() {}

// Deprecated: Use QueryLiquidityProviderRewardsResponse.ProtoReflect.Descriptor instead.
...
func (x *QueryLiquidityProviderRewardsResponse) GetPool() []*v1beta1.DecCoin {
	if x != nil {
		return x.Pool
	}
	return nil
...
var file_cosmos_distribution_v1beta1_query_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6f, 0x6c, 0x22, 0x26, 0x0a, 0x24, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4c, 0x69, 0x71,
	0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x52, 0x65,
	0x77, 0x61, 0x72, 0x64, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x8e, 0x01, 0x0a,
	0x25, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x50,
	0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x65, 0x0a, 0x04, 0x70, 0x6f, 0x6f, 0x6c, 0x18, 0x01,
	...
	0x65, 0x63, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x52, 0x04, 0x70, 0x6f, 0x6f, 0x6c, 0x32, 0xa9, 0x13,
	0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x98, 0x01, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61,
	0x6d, 0x73, 0x12, 0x2f, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x64, 0x69, 0x73, 0x74,
	0x72, 0x69, 0x62, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31,
	0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x30, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x64, 0x69, 0x73,
	...
	0x6d, 0x73, 0x12, 0xe9, 0x01, 0x0a, 0x19, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72,
	...
	0x75, 0x65, 0x72, 0x79, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x44, 0x69, 0x73,
	0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71,
	...
	0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x43, 0x82, 0xd3, 0xe4, 0x93, 0x02,
	0x3d, 0x12, 0x3b, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x64, 0x69, 0x73, 0x74, 0x72,
	...
	0x64, 0x61, 0x74, 0x6f, 0x72, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x7d, 0x12, 0x83,
	0x02, 0x0a, 0x1b, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x4f, 0x75, 0x74, 0x73,
	0x74, 0x61, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x12, 0x44,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x45, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x64, 0x69,
	0x73, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74,
	0x61, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f,
	0x72, 0x4f, 0x75, 0x74, 0x73, 0x74, 0x61, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x77, 0x61,
	0x72, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x57, 0x82, 0xd3, 0xe4,
	0x93, 0x02, 0x51, 0x12, 0x4f, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x64, 0x69, 0x73,
	...
	0x2f, 0x6f, 0x75, 0x74, 0x73, 0x74, 0x61, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x72, 0x65, 0x77,
	0x61, 0x72, 0x64, 0x73, 0x12, 0xe2, 0x01, 0x0a, 0x13, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74,
	0x6f, 0x72, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x3c, 0x2e, 0x63,
	...
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x3d, 0x2e, 0x63, 0x6f, 0x73,
	...
	,
	...
	0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x6c, 0x61, 0x73, 0x68, 0x65, 0x73, 0x52, 0x65, 0x73,
	...
	0x72, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x7d, 0x2f, 0x73, 0x6c, 0x61, 0x73, 0x68,
	0x65, 0x73, 0x12, 0xed, 0x01, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x12, 0x3a, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	0x73, 0x2e, 0x64, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x3b, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x64, 0x69,
	0x73, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74,
	...
	0x65, 0x22, 0x5f, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x59, 0x12, 0x57, 0x2f, 0x63, 0x6f, 0x73, 0x6d,
	...
	0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x7d, 0x12, 0xe8, 0x01, 0x0a, 0x16, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x12, 0x3f, 0x2e,
	...
	0x79, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x6f, 0x74, 0x61, 0x6c,
	0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x40,
	0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x64, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62, 0x75,
	0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x51, 0x75, 0x65,
	...
	0x72, 0x65, 0x73, 0x73, 0x7d, 0x2f, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x12, 0xe2, 0x01,
	0x0a, 0x13, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x6f, 0x72, 0x56, 0x61, 0x6c, 0x69, 0x64,
	0x61, 0x74, 0x6f, 0x72, 0x73, 0x12, 0x3c, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x64,
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x7d, 0x2f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f,
	0x72, 0x73, 0x12, 0xf7, 0x01, 0x0a, 0x18, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x6f, 0x72,
	...
	0x73, 0x74, 0x1a, 0x42, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x64, 0x69, 0x73, 0x74,
	0x72, 0x69, 0x62, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31,
	0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x6f, 0x72, 0x57,
	...
	0x6f, 0x72, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x7d, 0x2f, 0x77, 0x69, 0x74, 0x68,
	0x64, 0x72, 0x61, 0x77, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0xb5, 0x01, 0x0a,
	0x0d, 0x43, 0x6f, 0x6d, 0x6d, 0x75, 0x6e, 0x69, 0x74, 0x79, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x36,
	0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x64, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62, 0x75,
	0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x51, 0x75, 0x65,
	...
	,
...
var file_cosmos_distribution_v1beta1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_cosmos_distribution_v1beta1_query_proto_goTypes = []interface{}{
	...
	(*QueryLiquidityProviderRewardsRequest)(nil),     // 20: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsRequest
	(*QueryLiquidityProviderRewardsResponse)(nil),    // 21: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse
...
var file_cosmos_distribution_v1beta1_query_proto_depIdxs = []int32{
	...
	23, // 1: cosmos.distribution.v1beta1.QueryValidatorDistributionInfoResponse.self_bond_rewards:type_name -> cosmos.base.v1beta1.DecCoin
	23, // 2: cosmos.distribution.v1beta1.QueryValidatorDistributionInfoResponse.commission:type_name -> cosmos.base.v1beta1.DecCoin
	24, // 3: cosmos.distribution.v1beta1.QueryValidatorOutstandingRewardsResponse.rewards:type_name -> cosmos.distribution.v1beta1.ValidatorOutstandingRewards
	25, // 4: cosmos.distribution.v1beta1.QueryValidatorCommissionResponse.commission:type_name -> cosmos.distribution.v1beta1.ValidatorAccumulatedCommission
	26, // 5: cosmos.distribution.v1beta1.QueryValidatorSlashesRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	27, // 6: cosmos.distribution.v1beta1.QueryValidatorSlashesResponse.slashes:type_name -> cosmos.distribution.v1beta1.ValidatorSlashEvent
	28, // 7: cosmos.distribution.v1beta1.QueryValidatorSlashesResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	23, // 8: cosmos.distribution.v1beta1.QueryDelegationRewardsResponse.rewards:type_name -> cosmos.base.v1beta1.DecCoin
	...
	23, // 12: cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse.pool:type_name -> cosmos.base.v1beta1.DecCoin
	...
	20, // 23: cosmos.distribution.v1beta1.Query.LiquidityProviderRewards:input_type -> cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsRequest
	...
	21, // 34: cosmos.distribution.v1beta1.Query.LiquidityProviderRewards:output_type -> cosmos.distribution.v1beta1.QueryLiquidityProviderRewardsResponse
...
func file_cosmos_distribution_v1beta1_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_distribution_v1beta1_query_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryLiquidityProviderRewardsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cosmos_distribution_v1beta1_query_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryLiquidityProviderRewardsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
